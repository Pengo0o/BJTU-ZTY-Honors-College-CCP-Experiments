...
HD_PWD='E:/project/Experiment_6/display/display.runs/rom2_width8_addra16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom2_width8_addra16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom2_width8_addra16.tcl
