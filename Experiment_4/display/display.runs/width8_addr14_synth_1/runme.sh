...
HD_PWD='E:/project/display_3/display_1/display/display.runs/width8_addr14_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log width8_addr14.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source width8_addr14.tcl
