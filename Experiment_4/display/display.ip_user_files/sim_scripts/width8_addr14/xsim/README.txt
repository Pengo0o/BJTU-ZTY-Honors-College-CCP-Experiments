...
#
# Generated by export_simulation on Sat May 18 16:47:50 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './width8_addr14.sh' script.

./width8_addr14.sh -reset_run
...
./width8_addr14.sh -noclean_files

For more information on the script, please type './width8_addr14.sh -help'.
