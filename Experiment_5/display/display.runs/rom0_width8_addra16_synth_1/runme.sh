...
HD_PWD='E:/project/display/display.runs/rom0_width8_addra16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom0_width8_addra16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom0_width8_addra16.tcl
